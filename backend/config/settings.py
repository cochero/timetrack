"""
Django settings for the TimeTrack backend.
Everything sensitive is read from environment variables (.env file),
so the same code runs safely in development and production.
"""
...
# --- Database: PostgreSQL in production, SQLite for first local run ---
...
# Redis / Celery (used later for background reports & notifications)
REDIS_URL = env("REDIS_URL", default="redis://localhost:6379/0")
CELERY_BROKER_URL = REDIS_URL
CELERY_RESULT_BACKEND = REDIS_URL

# In production switch this to a Redis cache backend.
CACHES = {
