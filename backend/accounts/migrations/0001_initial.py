    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('OWNER', 'Owner'), ('ADMIN', 'Admin'), ('PROJECT_HEAD', 'Project Head'), ('PROJECT_MANAGER', 'Project Manager'), ('TEAM_LEADER', 'Team Leader'), ('EMPLOYEE', 'Employee')], default='EMPLOYEE', max_length=20)),
                ('timezone', models.CharField(default='Asia/Kolkata', max_length=64)),
                ('default_cost_rate', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('is_active', models.BooleanField(default=True)),
